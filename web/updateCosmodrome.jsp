...
<table class="table_price" cellspacing='0'>
    ...
    <form method="get" action="updateCosmodrome">
        <tr>
            <td>Название</td>
            <td>Страна</td>
        ...
        <tr>
            <td>
                <input type="text" value="<%=request.getParameter("cosmodrome_name") %>" name="cosmodrome_name">
            </td>
            <td>
                <input type="text" value="<%=request.getParameter("country") %>" name="country">
            </td>
            <td>
                <input type="text" value="<%=request.getParameter("timezone") %>" name="timezone">
            </td>

            <td>
                <button formaction="updateCosmodrome" >Обновить</button>
            </td>
    </form>
</table>
<center>
