...
@WebServlet(name = "addCosmodrome", urlPatterns = "/addCosmodrome")
public class addCosmodrome extends HttpServlet {
    CosmodromeDAO sd = new CosmodromeDAO();

    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        request.setCharacterEncoding("UTF-8");
        request.getRequestDispatcher("addCosmodrome.jsp").forward(request,response);
    }
