...
<table class="table_price" cellspacing='0'>
    ...
    <form method="get" action="updateRocket">
        <tr>
            <td>Название</td>
        ...
        <tr>
            <td>
                <input type="text" value="<%=request.getParameter("rocket_name") %>" name="rocket_name">
            </td>
            <td>
                <input type="text" value="<%=request.getParameter("engines_number") %>" name="engines_number">
            </td>
            <td>
                <input type="text" value="<%=request.getParameter("height") %>" name="height">
            </td>
...
<center>
    <br>
<a class="button8" href="Rocket.jsp">Отмена</a>
<br>
    <br>
